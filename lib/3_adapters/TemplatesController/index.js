...
const templatesRepository = TemplatesRepository_1.default.make(path_1.default.resolve(__dirname, "../../../templates"), path_1.default.resolve(process.cwd(), ".bystencil"), [".templaterc"]);
