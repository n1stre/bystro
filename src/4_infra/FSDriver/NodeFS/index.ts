...
import { IFileSystemDriver } from "../../../3_adapters/interfaces";

export default class NodeFileSystem implements IFileSystemDriver {
  public async writeFiles(files: { path: string; contents: string }[]) {
